...
async function main() {
    ...
    blocks: [
      {
        _type: 'hero',
        _key: 'hero1',
        heading: 'ODA Inspiration Day 2026',
    ...
    blocks: [
      {
        ...
        _key: 'hero1',
        heading: 'Speakers',
        subheading: 'Meet the brilliant minds taking the stage at ODA Inspiration Day 2026.',
        style: 'medium',
    ...
    blocks: [
      ...
      },
      {
        ...
        sessions: [
          ...
          { _key: 'se2', time: '09:00', title: 'Opening Ceremony', tag: 'keynote', description: 'Welcome to ODA Inspiration Day 2026!', location: 'Main Stage' },
    ...
    blocks: [
      {
        ...
        subheading: 'Secure your spot at ODA Inspiration Day 2026.',
        style: 'medium',
      ...
      },
      {
        ...
        body: 'Early bird pricing available until March 31, 2026. Regular tickets from NOK 1,990. Student tickets from NOK 490.',
        backgroundColor: 'lavender',
  ...
  await client.create({
    ...
    blocks: [
      ...
      },
      {
        ...
        content: [
          { _type: 'block', _key: 'b1', style: 'normal', children: [{ _type: 'span', _key: 's1', text: 'ODA Inspiration Day 2026 centres around the idea that diverse teams build better technology. From inclusive hiring practices to equitable product design, we explore every angle of what it means to create tech that works for everyone.' }] },
  ...
  await client.createOrReplace({
    _id: 'siteSettings',
    _type: 'siteSettings',
    siteName: 'ODA Inspiration Day 2026',
