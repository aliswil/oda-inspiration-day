...
export const SITE_DESCRIPTION = 'Join 11,000+ members of the Nordic tech community for ODA Inspiration Day — 29 May 2026, Oslo. The largest diversity in tech conference in the Nordics.'
export const EVENT_DATE = 'Friday 29 May 2026'
